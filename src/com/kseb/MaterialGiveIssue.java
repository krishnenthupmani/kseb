...
public class MaterialGiveIssue extends HttpServlet{
	...
	try {
		...
		out.print("<h4>Issue Material  </h4>");
		...
		out.print("<label>Remarks </label>");	
			out.print("<input type='text' name='issuestatus' /><br><br>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		con = dbcon.getConnection();
		pst1 = con.prepareStatement("update  material_req set  issue_date=?, issue_status=? where req_id=?");
		pst1.setDate(1, sqlDate);
		pst1.setString(2, issuestatus);
