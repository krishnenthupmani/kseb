...
@WebServlet("/MaterialManagerRequest")
public class MaterialManagerRequest extends HttpServlet {
	Connection con = null;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException  {
		try {
			...
			out.print("<body>");
			out.print("<h1>Welcome MaterialManager </h1>");
			...
			log("SQL Exception: " + sql.getMessage());
			sql.printStackTrace();
